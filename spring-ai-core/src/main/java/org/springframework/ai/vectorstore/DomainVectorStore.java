 ...
 * documents in a vector database. Vector databases are specialized for AI applications,
 * performing similarity searches based on vector representations of data rather than
 * exact matches. This interface allows for adding, deleting, and searching documents
 * based on their similarity to a given query.
 */
public interface DomainVectorStore<T>{
	 ...
	 * @return
	 */
	Optional<Boolean> delete(List<Object> idList);
